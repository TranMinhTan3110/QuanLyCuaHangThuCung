...
//        // Thay vì trả về JPanel từ UserView, ta sẽ mở UserView như một cửa sổ riêng biệt
//        userView.setVisible(true); // Hiển thị cửa sổ UserView
//        return new JPanel(); // Trả về một JPanel trống hoặc bạn có thể sử dụng một placeholder nào đó
//    }
//
//
