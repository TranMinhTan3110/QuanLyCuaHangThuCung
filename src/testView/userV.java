...
public class userV extends JFrame {
	 ...
	 */
	public userV() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(userV.class.getResource("/view/Icon/users_Icon.png")));
		...
		btnPets.setIcon(new ImageIcon(userV.class.getResource("/view/Icon/pets_Icon.png")));
		...
		btnUsers.setIcon(new ImageIcon(userV.class.getResource("/view/Icon/user1_Icon.png")));
		...
		btnCusTomers.setIcon(new ImageIcon(userV.class.getResource("/view/Icon/users_Icon.png")));
		...
		btnBills.setIcon(new ImageIcon(userV.class.getResource("/view/Icon/bill_Icon.png")));
		...
		btnLogout.setIcon(new ImageIcon(userV.class.getResource("/view/Icon/logout_Icon.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(userV.class.getResource("/view/Icon/user_main_Icon.png")));
		...
		btnCategory.setIcon(new ImageIcon(userV.class.getResource("/view/Icon/Category_Icon.png")));
